            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="{{URL::to('/')}}/profileImage/{{Auth::user()->profile->profile_image}}" class="user-image" alt="User Image">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="{{URL::to('/')}}/profileImage/{{Auth::user()->profile->profile_image}}" class="img-circle" alt="User Image">
